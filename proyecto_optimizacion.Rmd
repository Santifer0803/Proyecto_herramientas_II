...
Para poder utilizar el proyeto, se iniciará con la descarga de las librarías que se utilizaron (Se pondrán como un comentario ya que cada persona puede tener alguna de estas librerías, de esta manera se podrán elegir las que no se tengan individualmente).
...
Inicialmente, se procede a descargar la base da datos a utilizar para generar los gráficos.
